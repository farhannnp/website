...
if(isset($_POST['login'])) {
    ...
    if($user == 'miku' AND $pass == '220722') {
        header("Location: index.html");
    }else{
       echo'<script type="text/JavaScript">';
       echo'alert("PASSWORD SALAH, SILAKAN COBA LG YA DIK")';
       echo'</script>';
    }
}
?>
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="field">
                    ...
                    <input autocomplete="off" id="logemail" placeholder="Username" class="input-field" name="username" type="username">
                </div>
                <div class="field">
                    <svg class="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
